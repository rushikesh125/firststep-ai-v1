...
const ChatPopup = ({ isOpen, onClose, isMinimized, onMinimize }) => {
    ...
    const handleSend = async () => {
      ...
      setTimeout(() => {
        const aiResponse = {
          ...
          text: "I can help guide you through potential career paths based on your interests and skills. Would you like to explore specific roles or get general career advice?",
          isAi: true
        };
    ...
    return (
      <div className={`fixed right-4 ${isMinimized ? 'bottom-4 w-72 h-12' : 'bottom-4 w-96 h-[600px]'} 
        ...
        <div className="absolute top-0 left-0 right-0 bg-white rounded-t-2xl border-b border-gray-200">
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-sm font-semibold text-gray-900">Virtual AI Assistant</h3>
                {!isMinimized && (
